const COUNTRIES = [
  ...
  {name:"Rwanda",code:"rw"},{name:"Samoa",code:"ws"},{name:"San Marino",code:"sm"},
  ...
  {name:"Antigua and Barbuda",code:"ag"},{name:"Dominica",code:"dm"},
  {name:"Marshall Islands",code:"mh"},{name:"Saint Lucia",code:"lc"},
  {name:"Saint Vincent",code:"vc"},{name:"Sao Tome and Principe",code:"st"},
  {name:"Samoa",code:"ws"},{name:"Tuvalu",code:"tv"}
];
